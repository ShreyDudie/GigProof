...
class ZKProofService {
     ...
     */
    static async generateProof(request) {
     ...
     */
    static async verifyProof(proof, publicSignals, verificationKey) {
        // Mock verification
        // In real implementation, this would:
    ...
    static evaluateClaim(privateValue, claim) {
    ...
    static generateClaimStatement(credentialType, claim) {
...
//# sourceMappingURL=zkProof.js.map